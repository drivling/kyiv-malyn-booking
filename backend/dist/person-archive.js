...
exports.archivePersonData = archivePersonData;
/**
 ...
 */
async function archivePersonData(prisma, opts) {
    ...
    return prisma.$transaction(async (tx) => {
        ...
        console.log(`🗄️ Заархівовано персону #${id} (${person.phoneNormalized}): архів #${archive.id}, ` +
