      ...
      <div className="company-legal-card company-legal-card--wide">
        ...
        <div id={PRIVACY_SECTION_ID} className="company-legal-privacy">
          ...
          <section className="privacy-policy-section" aria-labelledby="privacy-cookies">
            ...
            <p>
              Сайт використовує файли cookie та подібні технології, зокрема для <strong>Google Analytics</strong> —
              знеособленої статистики відвідувань і покращення роботи сервісу. Дані обробляються згідно з політиками
              Google; ми намагаємося використовувати лише режими, сумісні з вимогами щодо захисту персональних даних.
            </p>
