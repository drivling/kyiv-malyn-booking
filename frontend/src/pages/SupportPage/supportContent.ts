...
export const CITY_TRANSPORT_FAQ: Array<{ q: string; a: string }> = [
  {
    ...
    a: 'На malin.kiev.ua/transport: планер «З → До», сторінки маршрутів і табло зупинок. Це живий розклад по місту, а не новина з Facebook чи архівний PDF.',
  },
  {
    q: 'Чому раніше не можна було знайти міський розклад у пошуку?',
    a: 'У Google й новинах легко знайти міжміські рейси (автостанція, Малин — Київ / Житомир) і зміни графіка як разові пости міськради. Зручного «табло» по зупинках у місті роками майже не було — люди питали в чатах, орієнтувалися «на око» або чекали на зупинці.',
  },
  {
