...
export const FAQ_PLAIN: Array<{ q: string; aText: string }> = [
  ...
  },
  {
    ...
    aText:
      'Так: міжміський пошук на /mizhgorodski, класичні попутки на /poputky, маршрутки на /booking. Підтвердження бронювання, нагадування і бонуси акції зручніше отримувати в Telegram-боті.',
  },
];
